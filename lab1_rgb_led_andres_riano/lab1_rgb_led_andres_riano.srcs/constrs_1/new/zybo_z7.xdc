##----------------------------------------------------------------------
## zybo_z7.xdc  -  Zybo Z7-10  -  ECE 520/L Lab 1
## Andres Riano
##
## Only the pins this design actually uses are uncommented.
##----------------------------------------------------------------------
...
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { rgb_out[0] }];
set_property -dict { PACKAGE_PIN F17  IOSTANDARD LVCMOS33 } [get_ports { rgb_out[1] }];
set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS33 } [get_ports { rgb_out[2] }];
